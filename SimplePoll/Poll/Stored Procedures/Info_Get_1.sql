...
if @_PollId <> '00000000-0000-0000-0000-000000000000' 
    begin
        ...
        select
			...
			,[PageTotal]			= count(srcTable.PollId) over (partition by 1) / @_PageSize
										+ case when count(srcTable.PollId) over (partition by 1) % @_PageSize > 0 then 1 else 0 end
        from
